#!/bin/sh
LOCAL_COMPILER=/home/securecrt/tools/gcc-linaro/bin/arm-eabi-
KERNELBASEDIR=/ics/kernel/out
rm arch/arm/boot/zImage
make htcleo_defconfig
make ARCH=arm CROSS_COMPILE=$LOCAL_COMPILER zImage -j8 && make ARCH=arm CROSS_COMPILE=$LOCAL_COMPILER modules -j8
...
make ARCH=arm CROSS_COMPILE=$LOCAL_COMPILER INSTALL_MOD_PATH=$KERNELBASEDIR/system/lib/modules modules_install -j8
